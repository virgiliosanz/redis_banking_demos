...
```
Genera una muestra en `runtime/metrics/metrics.db`. Con el stack completo se recolectan **104 muestras** por ejecucion (86 metricas de infraestructura + 18 metricas WordPress). Sin WordPress disponible, se recolectan **86 metricas** de infraestructura.
