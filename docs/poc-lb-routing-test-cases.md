...
| Front archive por anio | `nuevecuatrouno.test` | `/2019/05/noticia/` | `fe_archive`, `site_context=archive`, `docroot=/var/www/html/archive` |
| Front live por defecto | `nuevecuatrouno.test` | `/actualidad/post/` | `fe_live`, `site_context=live`, `docroot=/var/www/html/live` |
